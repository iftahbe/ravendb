    ...
    public unsafe class SecretProtection
    {
        ...
        public RavenServer.CertificateHolder LoadCertificateWithExecutable(string executable, string args, ServerStore serverStore)
        {
            ...
            try
            {
                ...
                loadedCertificate = new X509Certificate2(rawData, (string)null,X509KeyStorageFlags.Exportable | X509KeyStorageFlags.MachineKeySet | X509KeyStorageFlags.PersistKeySet);
        ...
        public RavenServer.CertificateHolder LoadCertificateFromPath(string path, string password, ServerStore serverStore)
        {
            try
            {
                ...
                var loadedCertificate = new X509Certificate2(rawData, password, X509KeyStorageFlags.Exportable | X509KeyStorageFlags.PersistKeySet | X509KeyStorageFlags.MachineKeySet);
